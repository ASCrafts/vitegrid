...
## Corpus Check
- 41 files · ~340,295 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 669 nodes · 1736 edges · 38 communities (29 shown, 9 thin omitted)
...
Cohesion: 0.12
Nodes (24): DEFAULT_STYLE_TOKENS, StyleTokens, alignmentFor(), ASTNode, blockToChildren(), cellPaddingFor(), CodeBlockNode, compileToDocx() (+16 more)

### Community 3 - "Backend FastAPI API & DB Storage"
Cohesion: 0.11
Nodes (50): Session, DeclarativeBase, FastAPI, getTemplate(), importLayout(), jsonOrThrow(), listTemplates(), saveTemplate() (+42 more)
...
Cohesion: 0.19
Nodes (11): Dashboard(), Props, App(), EMPTY_LAYOUT, isImage(), isPdf(), Workspace, AuditReport (+3 more)
...
Cohesion: 0.14
Nodes (13): Align, BlockType, BoundingBox, CellPaddingDxa, DEFAULT_SPACING_TOKENS, FontWeight, LineRule, ListFormat (+5 more)

### Community 31 - "Community 31"
Cohesion: 0.31
Nodes (10): ChatEditor(), ChatTurn, Props, HeadlessPreview(), LiveRender(), Props, RenderedBlock(), styleToCss() (+2 more)
...
## Knowledge Gaps
- **104 isolated node(s):** `python.defaultInterpreterPath`, `python.analysis.extraPaths`, `bool`, `Session`, `DocumentConverter` (+99 more)
...
- **Why does `generateFromPrompt()` connect `Agent Layout & Style Pipeline` to `Community 10`, `Backend FastAPI API & DB Storage`?**
